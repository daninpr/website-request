		...
		<div class="ts-main-content">
			...
			<div class="content-wrapper">
				<div class="container-fluid" style="margin-top:40px">
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-title">Tindak Lanjut</h2>
											...
											<tr>
												...
												<td><?php 
													if($result->status == "progress"){
														...
														echo '<div style="background: red; color:white; border-radius:6px; text-align:center">Open</div>';
													}
												?></td>
												<td><a href="review.php?nama_projek=<?php echo $result->nama_projek;?>"><i class="fa fa-fax"></i></a>&nbsp;&nbsp;</td>
												<td><a href="edit-konfirmasi.php?nama_projek=<?php echo $result->nama_projek;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;</td>
											</tr>
											<?php $cnt=$cnt+1; }} ?>
										</tbody>
									</table>
