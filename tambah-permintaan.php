...
if(strlen($_SESSION['alogin'])==0){	
	...
	if(isset($_POST['submit'])){
		...
		header('location:manage-permintaan.php');
	}
?>
<!doctype html>
										...
										<div class="panel-heading" style="color:black; background-color:#fade47">Form Pengisian Data Permintaan</div>
											...
											<form method="post" class="form-horizontal" enctype="multipart/form-data">
												<div class="form-group">
													...
													<div class="col-sm-4">
													<select class="selectpicker" data-size="7" name="depart" required>
													<option value=""> Pilih </option>

													<?php 
													
													$ret="select depart from tblauth where userType = 'user' ";
													...
													?>
													<option value="<?php echo htmlentities($result->depart);?>"><?php echo htmlentities($result->depart);?></option>
													<?php }} ?>
													</select>
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-4">
														<input type="text" name="userlog" class="form-control" required>
													</div>
												</div>
