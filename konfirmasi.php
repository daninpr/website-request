...
if(isset($_POST['submit'])) {
	...
	$sql="INSERT INTO tb_persetujuan(depart, nama_projek, userlog, anggaran, nominal, prioritas, tim_pm, tim_ba, tim_docs, tim_prog, tim_infra, nama_vendor, estimasi, tgl_mulai, tgl_selesai, brd, tor, sr, ba, ok, user_man) 
		  VALUES(:depart, :nama_projek, :userlog, :anggaran, :nominal, :prioritas, :tim_pm, :tim_ba, :tim_docs, :tim_prog, :tim_infra, :nama_vendor, :estimasi, :tgl_mulai, :tgl_selesai, :brd, :tor, :sr, :ba, :ok, :user_man)";
									...
									<div class="panel-heading" style="color:black; background-color:#fade47"> Info Permintaan</div>
                            			<div class="panel-body">
											<?php 
												...
												$sql ="SELECT * from tbl_permintaan where nama_projek=:nama_projek";
												$query = $dbh -> prepare($sql);
												$query-> bindParam(':nama_projek', $nama_projek, PDO::PARAM_STR);
												$query->execute();
									...
									<div class="panel-heading" style="background-color:#ffef8a"><font color="black" size="2pt">Tim</font></div>
                           				<div class="panel-body">
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="tim_pm" class="form-control" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="tim_ba" class="form-control" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="tim_docs" class="form-control" >
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="tim_prog" class="form-control" >
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Tim Infra<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="text" name="tim_infra" class="form-control" >
													</div>
											</div>
										</div>
